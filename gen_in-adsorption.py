...
def create_in_file(i):
    ref_filename="/deac/thonhauserGrp/chakrad/calculations/atomandmolecule-qe6.2.1-i2012-C6modif/coinage_metal_new/Cu-bz-PEC/vdw-df/input_xsf_files/adsorption_system_%02d.xsf"%i
...
'''
    ...
    file = open('adsorption_system_%02d.in'%i,'w')
