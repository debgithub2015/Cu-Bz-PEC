...
mol_overlay_path="/deac/thonhauserGrp/chakrad/calculations/atomandmolecule-qe6.2.1-i2012-C6modif/coinage_metal_new/Cu-bz-PEC/vdw-df/molecular_overlayer"

for i in {00..30}; do
mpirun $pwdir < $mol_overlay_path/molecule_overlayer_system_$i.in > $mol_overlay_path/molecule_overlayer_system_$i.out
done
